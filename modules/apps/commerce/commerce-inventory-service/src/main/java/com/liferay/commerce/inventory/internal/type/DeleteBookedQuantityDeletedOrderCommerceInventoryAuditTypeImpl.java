 ...
 */
@Component(
	property = "commerce.inventory.audit.type.key=" + CommerceInventoryConstants.AUDIT_TYPE_DELETE_QUANTITY_DELETED_ORDER,
	service = CommerceInventoryAuditType.class
)
public class DeleteBookedQuantityDeletedOrderCommerceInventoryAuditTypeImpl
	...
	public String formatLog(long userId, String context, Locale locale)
		...
		return _language.format(
			locale, "x-deleted-the-order-x-restocking-quantity",
			new Object[] {
				user.getFullName(),
